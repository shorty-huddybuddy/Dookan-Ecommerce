...
// Source: ./sanity/lib/products/getAllProductByCategory.ts
...
// Variable: PRODUCT_BYID_QUERY
// Query: *[                _type=="product" && slug.current==$slug            ] | order(name asc)[0]
export type PRODUCT_BYID_QUERYResult = {
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: ALL_PRDUCT_QUERY
// Query: *[_type=="product"] | order(name asc)
export type ALL_PRDUCT_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: PRODUCT_QUERY_SEARCH
// Query: *[                _type=='product'                && name match $searchParam            ] | order(name asc)
export type PRODUCT_QUERY_SEARCHResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Source: ./sanity/lib/sales/getAllSaleByCouponCode.ts
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n            *[\n                _type==\"product\" && slug.current==$slug\n            ] | order(name asc)[0]\n        ": PRODUCT_BYID_QUERYResult;
    "\n        *[_type==\"category\"] | order(name asc)\n        ": ALL_CATEGORY_QUERYResult;
    "\n        *[_type==\"product\"] | order(name asc)\n        ": ALL_PRDUCT_QUERYResult;
    "\n            *[\n                _type=='product'\n                && name match $searchParam\n            ] | order(name asc)\n        ": PRODUCT_QUERY_SEARCHResult;
